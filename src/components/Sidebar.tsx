...
function Sidebar(this: FC<{ active?: PageCategory }>) {
	...
	return (
		<aside class="sidebar">
			<div class="top-blur" aria-hidden="true">
				<div class="top-blur-layer" style="--blur: 1px; --mid: 50%; --end: 100%;"></div>
				<div class="top-blur-layer" style="--blur: 2px; --mid: 40%; --end: 80%;"></div>
				<div class="top-blur-layer" style="--blur: 3px; --mid: 30%; --end: 60%;"></div>
				<div class="top-blur-layer" style="--blur: 6px; --mid: 20%; --end: 40%;"></div>
				<div class="top-blur-layer" style="--blur: 10px; --mid: 10%; --end: 20%;"></div>
			</div>
			<TransitionLink href="/" class="site-title-link">
				<h1 class="site-title background-container geist-anim">
					<img src="/pfp-display-new.png" height="64" class="site-title-pfp" loading="eager" alt="my profile picture" />
					<span>bomberfish.ca</span>
				</h1>
			</TransitionLink>
			<nav class="sidebar-nav">
				<TransitionLink href="/" class={`nav-link background-container ${active === "home" ? "active" : ""}`}>
				...
				<TransitionLink href="/projects" class={`nav-link background-container ${active === "projects" ? "active" : ""}`}>
				...
				<TransitionLink href="/blog" class={`nav-link background-container ${active === "blog" ? "active" : ""}`}>

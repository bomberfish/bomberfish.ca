export const title = "MacDirtyCow app development: From zero to hero.";
export const tags = ["Tutorials", "Apple"];
export const image = "/blog-images/xc-starter.png";
export const description = "A walkthrough for building an app that leverages the MacDirtyCow exploit (MDC).";
...
![Xcode Startup Screen](/blog-images/xcode-home.png)

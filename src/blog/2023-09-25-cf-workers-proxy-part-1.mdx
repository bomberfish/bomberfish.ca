export const title = "Proxying on the Edge: Part 1";
export const tags = ["Devlog", "Web Proxies"];
export const description = "Part 1 of a series about running web proxies using Cloudflare Workers (Superposition).";

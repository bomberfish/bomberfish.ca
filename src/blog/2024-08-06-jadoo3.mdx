export const title = "How I hacked an obscure set-top box from 2013";
export const tags = ["Writeup", "Hardware"];
export const image = "/blog-images/jadoo3.webp";
export const description = "How I gained root access to a Jadoo3 set-top box and what I discovered during the investigation.";

![Jadoo3](/blog-images/jadoo3.webp)
...
![Jadoo3 PCB, top view](/blog-images/jadoo3-pcb-1.jpg)
...
![Jadoo3 PCB, front-left view](/blog-images/jadoo3-pcb-2.jpg)
...
![Love is in the air? Wrong. Exposed root shell on port 23](/blog-images/love-in-the-air.jpg)

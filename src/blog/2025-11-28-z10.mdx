...
> Update (2026-01-03):
> I managed to figure out that running `displayctl power_off; displayctl power_on` through the exposed telnet root shell brought the display up manually. I might do a quick follow up post later about all the interesting internal goodies and whatnot I was able to find.

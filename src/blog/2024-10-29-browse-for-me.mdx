export const title = "How I hijacked Arc Search";
export const tags = ["Writeup"];
export const image = "/blog-images/bfm-fake-quote.jpg";
export const description = "How I made an Arc Search Browse For Me shared link display arbitrary content, and why this can be abused.";
...
![BFM showing custom page on desktop](/blog-images/bfm-desktop.jpeg)

It even works on the Arc Search app, when visiting the shared link:

![Arc Search on iOS showing custom page](/blog-images/bfm-mobile.jpg)
...
![Fake quote from arc.net](/blog-images/bfm-fake-quote.jpg)

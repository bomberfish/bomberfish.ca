...
export const image = "/blog-images/bfm-fake-quote.png";
export const description = "How I made an Arc Browse For Me shared link display arbitrary content and why this can be abused.";
...
![Arc Search on iOS showing custom page](/blog-images/bfm-mobile.png)
...
![Fake quote from arc.net](/blog-images/bfm-fake-quote.png)

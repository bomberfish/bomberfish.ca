...
export const description = "While working on a tool which transfers playlists between music streaming services, I had to reverse-engineer Apple Music's API. This article goes over some of the endpoints the API has to offer.";

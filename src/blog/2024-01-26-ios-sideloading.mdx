export const title = "iOS Sideloading: The Rundown";
export const tags = ["News", "Apple", "Opinion"];
export const description = "Explains Apple’s iOS sideloading changes for the EU, how they work, and implications for developers and users.";
